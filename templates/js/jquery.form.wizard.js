	...
	$.widget("ui.formwizard", {
		...
		_init: function() {
			...
			if(!this.options.disableUIStyles){
				this.element.addClass("uihelper-reset uiwidget uiwidget-content uihelper-reset uicorner-all");
				this.element.find(":input").addClass("uihelper-reset uistate-default");
				this.steps.addClass("uihelper-reset uicorner-all");
				this.backButton.addClass("uihelper-reset uistate-default");
				this.nextButton.addClass("uihelper-reset uistate-default");
			}
		...
		_disableNavigation : function(){
			...
			if(!this.options.disableUIStyles){
				this.nextButton.removeClass("uistate-active").addClass("uistate-disabled");
				this.backButton.removeClass("uistate-active").addClass("uistate-disabled");
			}
		},
		...
		_enableNavigation : function(){
			...
			if($.trim(this.currentStep) !== this.steps.eq(0).attr("id")){
				...
				if(!this.options.disableUIStyles){
					this.backButton.removeClass("uistate-disabled").addClass("uistate-active");
				}
			}

			this.nextButton.removeAttr("disabled");
			if(!this.options.disableUIStyles){
				this.nextButton.removeClass("uistate-disabled").addClass("uistate-active");
			}
		},
	  ...
	  /*Methods*/
		...
		destroy: function() {
			...
			this.nextButton.unbind("click").val(this.nextButtonInitinalValue).removeClass("uistate-disabled").addClass("uistate-active");
			this.backButton.unbind("click").val(this.backButtonInitinalValue).removeClass("uistate-disabled").addClass("uistate-active");
		...
		update_steps : function(){
			...
			if(!this.options.disableUIStyles){
				this.steps.addClass("uihelper-reset uicorner-all");
				this.steps.find(":input").addClass("uihelper-reset uistate-default");
			}
		},
